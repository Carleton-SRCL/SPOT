classdef InitializeForPWM < matlab.System ...
    ...
    methods
        % Constructor
        function obj = InitializeForPWM(varargin)
        ...
        function setupImpl(obj)
            if isempty(coder.target)
                ...
                % Call C-function implementing device initialization
                 ...
                 coder.ceval('initialize_dynamixel_PWM_control',obj.PWM_LIMIT);
            end
        end
    ...
    methods (Static, Access=protected)
        ...
        function header = getHeaderImpl
            header = matlab.system.display.Header('InitializeForPWM','Title',...
                'Dynamixel Actuator - Initialize PWM Control','Text',...
                ['This simulink block initializes the actuators for PWM control. '...
