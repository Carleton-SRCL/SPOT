classdef InitializeForTorque < matlab.System ...
    ...
    methods
        % Constructor
        function obj = InitializeForTorque(varargin)
        ...
        function setupImpl(obj)
            if isempty(coder.target)
                ...
                % Call C-function implementing device initialization
                 ...
                 coder.ceval('initialize_dynamixel_current_control',obj.CURRENT_LIMIT);
            end
        end
    ...
    methods (Static, Access=protected)
        ...
        function header = getHeaderImpl
            header = matlab.system.display.Header('InitializeForTorque','Title',...
                'Dynamixel Actuator - Initialize Torque Control','Text',...
                ['This simulink block initializes the actuators for torque control. '...
