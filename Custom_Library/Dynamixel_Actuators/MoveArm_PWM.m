classdef MoveArm_PWM < matlab.System ...
    ...
    methods
        % Constructor
        function obj = MoveArm_PWM(varargin)
        ...
        function stepImpl(~,u1,u2,u3)  
            if isempty(coder.target)
                ...
                %coder.ceval('sink_output',u);
                 ...
                 coder.ceval('command_dynamixel_PWM', u1, u2, u3);
            end
        end
