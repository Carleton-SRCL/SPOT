classdef MoveArm_Special < matlab.System ...
    ...
    methods
        % Constructor
        function obj = MoveArm_Special(varargin)
        ...
        function stepImpl(~,u1,u2,u3)  
            if isempty(coder.target)
                ...
                %coder.ceval('sink_output',u);
                 ...
                 coder.ceval('command_dynamixel_special', u1, u2, u3);
            end
        end
    ...
    methods (Static, Access=protected)
        ...
        function header = getHeaderImpl
            header = matlab.system.display.Header('MoveArm_Special','Title',...
                'Dynamixel Actuator - Torque Control','Text',...
                ['This simulink block sends the input to the Dynamixel actuators. '...
                'The input must be the desired joint torques in [Nm].'...
