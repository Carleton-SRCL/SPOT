classdef MoveArm_Torque < matlab.System ...
    ...
    methods
        % Constructor
        function obj = MoveArm_Torque(varargin)
        ...
        function stepImpl(~,u1,u2,u3)  
            if isempty(coder.target)
                ...
                %coder.ceval('sink_output',u);
                 ...
                 coder.ceval('command_dynamixel_current', u1, u2, u3);
            end
        end
    ...
    methods (Static, Access=protected)
        ...
        function header = getHeaderImpl
            header = matlab.system.display.Header('MoveArm_Torque','Title',...
