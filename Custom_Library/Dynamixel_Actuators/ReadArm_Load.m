classdef ReadArm_Load < realtime.internal.SourceSampleTime ...
    ...
    methods
        % Constructor
        function obj = ReadArm_Load(varargin)
    ...
    methods (Access=protected)
        ...
        function [y1, y2, y3] = stepImpl(obj)
            ...
            if isempty(coder.target)
                ...
                coder.ceval('read_dynamixel_load',coder.ref(y1),...
                             coder.ref(y2),coder.ref(y3));
    ...
    methods (Static, Access=protected)
       ...
       function header = getHeaderImpl
            header = matlab.system.display.Header('ReadArm_Load','Title',...
                'Read Dynamixel - Joint Angles','Text',...
                ['This block read the joint load on the'...
                 ' dynamixel actuators. The output is the 3 joint loads in percent of max load.' newline]);
        end
