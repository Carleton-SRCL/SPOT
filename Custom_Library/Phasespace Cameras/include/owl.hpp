...
namespace OWL {
  ...
  struct OWLAPI PackInfo {
    ...
    PackInfo(uint16_t type_id=0, const std::string &name=std::string(),
             const std::string &options=std::string(),
             const std::vector<uint64_t> &ids=std::vector<uint64_t>());
    PackInfo(uint16_t type_id, const std::string &name,
             const std::string &options, const std::string &ids);
  };
  ...
  public:
    ...
    std::vector<TrackerInfo> findTrackerInfo(const std::string &type, const std::string &name=std::string()) const;
    ...
    FilterInfo filterInfo(const std::string &name) const;

    // devices //

    bool deviceOptions(uint64_t hw_id, const std::string &device_options);

    std::vector<DeviceInfo> findDeviceInfo(const std::string &type, const std::string &name=std::string()) const;
    ...
    std::vector<PackInfo> packInfo() const;
