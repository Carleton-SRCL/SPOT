    ...
    methods (Static, Access=protected)
        ...
        function header = getHeaderImpl
            header = matlab.system.display.Header('IdentifyPlatform','Title',...
                ...
                ['This simulink block opens, reads, and outputs the contents of the '...
                'text file WhoAmI.txt, which is located in: ' ...
                newline newline '/home/pi/ExperimentSoftware/'...
                newline newline 'Each platform has '...
                'its own unique ID #, as per the legend below:'...
                newline newline 'ID #1 = RED' newline 'ID #2 = BLACK'...
                newline 'ID #3 = BLUE' newline]);
        end
