...
namespace OWL {
  ...
  struct OWLAPI TrackerInfo {
    ...
    TrackerInfo(uint32_t id=-1, const std::string &type=std::string(),
		const std::string &name=std::string(),
		const std::string &options=std::string(),
		const std::vector<uint32_t> &marker_ids=std::vector<uint32_t>());
    TrackerInfo(uint32_t id, const std::string &type, const std::string &name,
  ...
  struct OWLAPI FilterInfo {
    ...
    std::string name;
    std::string options;
    FilterInfo(uint32_t period=0, const std::string &name=std::string(),
               const std::string &options=std::string());
  };
